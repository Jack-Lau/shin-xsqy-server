 ...
 * @author Darkholme
 */
public class SkillPerformer_103301 implements BuffAttachSkillPerformer {
    ...
    public List<Affect> processMainTarget(Unit source, Unit target, int processCount, SkillParameterTable skillParameterTable, int skillLevel, int targetCount, DamageValue cost) {
        ...
        Buff buff = prototype.createBuff(source, 103301, parameterSpace, countDown, skillLevel);
        //
        double extra基础命中率 = source.getParameter(ParameterNameConstants.封魂咒强化).getValue() > 0 ? 0.05 : 0;
        SkillParameterTable spt = SkillParameterTable.builder()
                ...
                .基础命中率(skillParameterTable.get基础命中率() + extra基础命中率)
        ...
        return Collections.singletonList(
                new AttachBuffAffect(source, buff, spt, skillLevel, processCount)
        );
    }
