 ...
 * @author Darkholme
 */
public class SkillPerformer_104201 implements ResourceSkillPerformer {
    ...
    public List<Affect> processMainTarget(Unit source, Unit target, int processCount, SkillParameterTable skillParameterTable, int skillLevel, int targetCount, DamageValue cost) {
        double extra易伤率 = source.getParameter(ParameterNameConstants.五庄奇穴3_乙).getValue() > 0
                ? 0.04 + source.getParameter(ParameterNameConstants.五庄奇穴3_乙).getValue() * 0.006 : 0;
